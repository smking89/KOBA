...
import { listProductComments } from "@/features/marketplace/services/product-comment.service";
import { ProductCommentSection } from "@/features/marketplace/components/product-comment-section";
...
export default async function ProductDetailPage({
  ...
  return (
    <div className="space-y-8">
      ...
      <ProductCommentSection slug={product.slug} initial={comments} signedIn={signedIn} />
    </div>
  );
}
