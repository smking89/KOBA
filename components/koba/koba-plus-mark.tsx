 ...
 * at the lower-right, in KOBA's green→yellow→orange→red spectrum
 * gradient. `public/brand/badge-plus.png` (read by KobaBadgeArt/PlusBadge
 * elsewhere in the app) currently contains an unrelated crossed-swords
 * image — a real asset mixup, not this mark — fixed by regenerating that
 * PNG from this component (see the badge-gen script) rather than by
 * editing KobaBadgeArt's call sites.
 *
 ...
 */
export function KobaPlusMark({ size = 64, className }: { size?: number; className?: string }) {
  return (
    <svg
      viewBox="0 0 100 100"
      width={size}
